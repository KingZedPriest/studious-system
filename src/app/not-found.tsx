  ...
  return (
    <main className="w-full h-screen flex items-center justify-center">
      <div className="relative flex flex-col items-center text-center gap-y-5 px-4">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-accentBlue">The Page you are trying to reach could not be found at the moment.</p>
          <p className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-accentBlue">Please try again later.</p>
